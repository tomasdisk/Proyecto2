...
DROP USER IF EXISTS 'flaskapp1_1_users'@'%';
CREATE USER 'flaskapp1_1_users'@'%' IDENTIFIED BY 'flaskapp';
GRANT SELECT, INSERT, DELETE ON flaskapp1_1.users TO 'flaskapp1_1_users'@'%';
