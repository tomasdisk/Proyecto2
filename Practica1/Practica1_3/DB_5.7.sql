...
DROP USER IF EXISTS 'flaskapp1_3_mic'@'%';
CREATE USER 'flaskapp1_3_mic'@'%' IDENTIFIED BY 'flaskapp';
GRANT INSERT ON flaskapp1_3.samples TO 'flaskapp1_3_mic'@'%';

-- crea usuario para la app flask con permisos especificos
DROP USER IF EXISTS 'flaskapp1_3_app'@'%';
